...
TMPlugin.Shooting.BulletFileName     =   TMPlugin.Shooting.Parameters['bulletFileName'] || 'shootingBullet%1';
...
TMPlugin.Shooting.UseGameover        =   TMPlugin.Shooting.Parameters['useGameover'] === '1';
TMPlugin.Shooting.MaxPlayerBullet    =   TMPlugin.Shooting.Parameters['maxPlayerBullet'];
TMPlugin.Shooting.MaxEnemyBullet     =   TMPlugin.Shooting.Parameters['maxEnemyBullet'];
TMPlugin.Shooting.EquipDummyX        = +(TMPlugin.Shooting.Parameters['equipDummyX'] || 0);
TMPlugin.Shooting.EquipDummyY        = +(TMPlugin.Shooting.Parameters['equipDummyY'] || 0);
TMPlugin.Shooting.UseLevelUpMessage  =   TMPlugin.Shooting.Parameters['useLevelUpMessage'] === '1';
...
(function() {
  ...
  Game_System.prototype.isPlayerShotEnabled = function() {
    if (this._playerShotEnabled == null) this._playerShotEnabled = true;
  ...
  Game_System.prototype.isEnemyShotEnabled = function() {
    if (this._enemyShotEnabled == null) this._enemyShotEnabled = true;
  ...
  Game_Map.prototype.setup = function(mapId) {
    ...
    if (TMPlugin.Shooting.ResetDeadSwitch) {
      this.events().forEach(function(event) {
        var key = [this._mapId, event.eventId(), TMPlugin.Shooting.DeadSwitch];
  ...
  Game_Bullet.prototype.setup = function(x, y, z, vx, vy, angle, count, type,
    ...
    if (this._type !== type) {
      this._type = type;
      this._bulletName = TMPlugin.Shooting.BulletFileName.format(type);
  ...
  Game_Bullet.prototype.executeDamage = function(character) {
    ...
    if (ownerBattler && target) {
      ...
      if (target.result().isHit()) {  // ヒットアニメーション
...
/*      if (TMPlugin.Shooting.UseExpPopup) {
...
/*      if (TMPlugin.Shooting.UseGoldPopup) {
